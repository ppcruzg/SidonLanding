                    ...
                    <div className="grid lg:grid-cols-2 gap-16 items-center">
                        ...
                        >
                            ...
                            <div className="flex flex-col sm:flex-row gap-4">
                                <Button size="lg" className="bg-emerald-600 hover:bg-emerald-500 text-white rounded-xl h-14 px-8 font-bold group">
                                    {t("sense.hero.cta")}
            ...
            <section className="py-24 border-t border-slate-900">
                <div className="max-w-4xl mx-auto px-6 text-center space-y-12">
                    ...
                    <div className="flex flex-col sm:flex-row gap-6 justify-center">
                        <Button size="lg" className="bg-emerald-600 hover:bg-emerald-500 text-white rounded-2xl h-16 px-12 text-xl font-bold shadow-2xl shadow-emerald-500/20">
                            Solicitar Demo
                        </Button>
                        <Button size="lg" variant="outline" className="border-slate-700 text-white hover:bg-slate-900 rounded-2xl h-16 px-12 text-xl font-bold">
                            Hablar con Experto
                        </Button>
                    </div>
                </div>
